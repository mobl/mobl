...
public class MoBLParseControllerGenerated extends DynamicParseController 
{ 
  ...
  { 
    MoBLParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = MoBLParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = MoBLParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(MoBLParseControllerGenerated.class);
    }
